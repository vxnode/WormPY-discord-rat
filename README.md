...
**Usage**
The bot-manager has to be running on the **attackers computer** for clients to connect to the discord bot. 
There is no builder yet for the bot-manager, you will manually have to insert your guild id and bot token.
